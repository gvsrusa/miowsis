      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Join MIOwSIS and start your sustainable investment journey
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {authError && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full" 
              disabled={isLoading || !email || !password || !confirmPassword || !name || !passwordValidation.isValid || !passwordsMatch}
            >
