  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signin') {
        ...
        // Handle signup - will be implemented in next step
        setAuthError('Signup functionality will be implemented')
      }
    } catch (error) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">Welcome to MIOwSIS</CardTitle>
          <CardDescription className="text-center">
            Sign in to start your sustainable investment journey
          </CardDescription>
        </CardHeader>
